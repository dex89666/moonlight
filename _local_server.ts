...
try {
    matrixHandler = (await import('./api/matrix.js')).default
} catch (_) {}
try {
    tarotHandler = (await import('./api/tarot.js')).default
} catch (_) {}
try {
    compatHandler = (await import('./api/compat.js')).default
} catch (_) {}
try {
    zodiacHandler = (await import('./api/zodiac.js')).default
} catch (_) {}
try {
    proHandler = (await import('./api/pro.js')).default
} catch (_) {}
